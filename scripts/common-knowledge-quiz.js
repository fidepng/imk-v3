...
const questions = [
  {
    image: "/imk-v3/assets/animal/kucing2.svg",
  ...
  {
    image: "/imk-v3/assets/animal/kucing1.svg",
    question: "Apa nama hewan ini?",
    answers: [
      { text: "Anjing", correct: false },
...
function showFinalScore() {
  ...
  if (percentage === 100) {
    ...
    trophyImage.src = "/imk-v3/assets/gold-trophy.svg";
  } else if (percentage >= 80) {
    message = "Luar biasa! Terus berlatih ya! 😄";
    trophyImage.src = "/imk-v3/assets/silver-trophy.svg";
  } else if (percentage >= 60) {
    message = "Bagus! Kamu sudah hampir menguasainya! 👍";
    trophyImage.src = "/imk-v3/assets/bronze-trophy.svg";
  } else {
    message = "Jangan menyerah, terus belajar! 💪";
    trophyImage.src = "/imk-v3/assets/participation-trophy.svg";
  }
...
function playSound(type) {
  const audio = new Audio(`/imk-v3/assets/sound/${type}.wav`);
